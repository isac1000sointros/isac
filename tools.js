...
function playerstableobjtostring24(obj){
    ...
    const keysorder=['haircolorcode', 'facialhairtypecode', 'curve', 'jerseystylecode',
    ...
    'penalties', 'animfreekickstartposcode', 'lipcolor', 'isretiring', 'longshots', 'gkdiving',
    'icontrait2', 'interceptions', 'shoecolorcode2', 'crossing', 'potential',
    'gkreflexes', 'finishingcode1', 'reactions', 'composure', 'skinsurfacepack', 'vision',
    'contractvaliduntil', 'finishing', 'dribbling', 'slidingtackle', 'accessorycode3',
    'accessorycolourcode1', 'headtypecode', 'firstnameid', 'driref', 'sprintspeed', 'height', 'role3',
    'hasseasonaljersey', 'tattoohead', 'preferredposition2', 'strength', 'shoetypecode',
    'birthdate', 'preferredposition1', 'tattooleftleg', 'skinmakeup', 'ballcontrol', 'phypos',
    'shotpower', 'trait1', 'socklengthcode', 'weight', 'hashighqualityhead', 'eyedetail', 'gkglovetypecode',
    'tattoorightarm', 'icontrait1', 'balance', 'gender', 'headassetid',
    'gkkicking', 'lastnameid', 'defspe', 'internationalrep', 'shortpassing', 'freekickaccuracy',
    'skillmoves', 'faceposerpreset', 'usercaneditname', 'avatarpomid',
    'finishingcode2', 'role2', 'aggression', 'acceleration', 'paskic', 'headingaccuracy', 'role1',
    ...
    'playerjointeamdate', 'headclasscode', 'tattoofront', 'nationality',
    'preferredfoot', 'sideburnscode', 'weakfootabilitytypecode', 'jumping', 'skintypecode', 'personality',
    ...
    'muscularitycode', 'skincomlexion', 'jerseyfit', 'accessorycode2', 'shoedesigncode', 'playerjerseynameid', 'shoecolorcode1',
    'hairstylecode', 'commonnameid', 'bodytypecode', 'animpenaltiesstartposcode', 'pacdiv', 'defensiveawareness',
